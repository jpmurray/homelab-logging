...
GitHub Actions tests the project and publishes `homelab-logging-1.5.0-linux-amd64.zip`.
...
Pass `--version 1.5.0` to install or roll back to a specific release. Previous releases remain under `/opt/homelab-logging/releases`.
